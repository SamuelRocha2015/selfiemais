         ...
         <div class="inner-1">     
          ...
          <ul class="list-blog">
            ...
            <div class="clear"></div>            
              ...
              <p>Você pode personalizar o totem de fotos com sua marca ou tema, de acordo com o seu evento ou sua festa. Os convidados se divertem, interagem com o seu logo/tema e ainda levam para casa uma lembrança impressa e compartilham nas redes sociais.</p>

          </div>  
        </article>
        <arh3ticle class="span4">
          ...
          <ul class="list extra extra1">           
            ...
            <li><a href="#">Acessórios divertidos</a></li>
            <li><a href="#">Banner</a></li>
            <li><a href="#">Impressão na Hora</a></li>
            <li><a href="#">2 promotores durante o evento</a></li>        
            <li><a href="#">Transporte</a></li>        
                          
      </ul>
          <h3>Opcionais</h3>
         <ul class="list extra extra1">           
            <li><a href="#">Personalização do Totem</a></li>
            <li><a href="#">Personalização do Banner</a></li>
            <li><a href="#">DVD personalizado com todas as fotos do evento</a></li>             
      </ul>
